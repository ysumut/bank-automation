...
public class CustomersGUI extends javax.swing.JFrame {
     ...
     */
    public CustomersGUI(String[] userData) {
        initComponents();
        ...
        String header[] = new String[] {"Ad Soyad","Email","TC No","Adres","Durum"};
        dtm.setColumnIdentifiers(header);
        personnelTable.setModel(dtm);
        
        String[][] customers = personnel.getCustomers();
    ...
    private void initComponents() {
        ...
        anaEkranText1.setText("Müşteri Ekleme");
        ...
        anaEkranText2.setText("Müşteriler");
    ...
    private void ekleButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ekleButtonActionPerformed
        ...
        if(response[0].equals("true")) {
            ...
            String[][] personnels = personnel.getCustomers();
            for (int i = 0; i < personnels.length; i++)
                if(personnels[i][0] != null) dtm.addRow(personnels[i]);

            JOptionPane.showMessageDialog(this, "Müşteri eklendi. Yönetici onayı bekleniyor.", "Başarılı", JOptionPane.INFORMATION_MESSAGE);
        }
        else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new CustomersGUI(userData).setVisible(true);
            }
        });
    }
